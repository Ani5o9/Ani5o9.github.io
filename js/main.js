...
function check() {
  ...
  if (result != null) {
    ...
    if (confirm(winner)) setTimeout(reset, 4000);
  }
}
...
function Edith() {
  ...
  document.getElementById(bestMove.i + "," + bestMove.j).innerHTML =
    "<h1>O</h1>";
  document.getElementById(bestMove.i + "," + bestMove.j).style.backgroundColor =
    "royalblue";
...
var state = false;
var res;
var starts = new Audio("./assests/hard.mp3");
